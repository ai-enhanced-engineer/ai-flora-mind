...
if __name__ == "__main__":
    ...
    try:
        ...
        y_pred_strings = classify_batch(petal_lengths, petal_widths)

        # Convert string predictions to numeric for evaluation
        species_to_numeric = {"setosa": 0, "versicolor": 1, "virginica": 2}
        y_pred = np.array([species_to_numeric[pred] for pred in y_pred_strings])

        # Step 4: Evaluate performance
        results = evaluate_model(y_true, y_pred, iris_data)
